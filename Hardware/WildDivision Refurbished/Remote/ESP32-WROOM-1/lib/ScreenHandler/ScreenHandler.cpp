...
void ScreenHandler::initializeScreens()
{
    ...
    screens["init1"] = {"== ІНІЦІАЛІЗАЦІЯ 2 ==", "Корекція датчика", "Похибка: {0}", "< 4 ліво    право 6 >", "             далі #"};
    screens["init2"] = {"== ІНІЦІАЛІЗАЦІЯ 3 ==", "Поточний азимут", "Задається цифрами", "Азимут: {0}", "             далі #"};
    screens["init3"] = {"== ІНІЦІАЛІЗАЦІЯ 4 ==", "Кут: {0}", "Азимут: {1}", "Похибка: {2}", "     для завершення #"};

    screens["main"] = {"--------МЕНЮ----------", "1-Азимут", "2-Кут", "3-Налаштування", "4-Інформація"};
    screens["azimuth"] = {"-------АЗИМУТ--------", "Поточний: {0}", "Заданий: {1}", "", "* назад    задати #"};
    screens["angle"] = {"--------КУТ----------", "Поточна: {0}", "Заданий: {1}", "", "* назад    задати #"};
